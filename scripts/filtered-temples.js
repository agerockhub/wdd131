...
const temples = [
    ...
    },
    {
        ...
        area: 42652,
        imageUrl: "https://churchofjesuschristtemples.org/assets/img/temples/london-england-temple/london-england-temple-7194.jpg"
    },
    {
        templeName: "Manti Utah",
        location: "Manti",
...
// Clear and render temple cards
function renderTemples(filteredTemples) {
    const main = document.querySelector(".res-grid");
    main.innerHTML = '<h2>Temples around the world</h2>'; // Reset content
...
// Convert dedicated string to year
